...
public class EncryptionUtil {
    ...
    public static PublicKey getPublicKey(String publicKeyString) {
        try {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                publicKeySpec = new X509EncodedKeySpec(Base64.getDecoder().decode(publicKeyString));
            }
    ...
    public static PrivateKey getPrivateKey(String privateKeyString) {
        try {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                privateKeySpec = new PKCS8EncodedKeySpec(Base64.getDecoder().decode(privateKeyString));
            }
    ...
    public static String decodeBase64(String base64Text) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            base64Bytes = Base64.getDecoder().decode(base64Text);
        }
