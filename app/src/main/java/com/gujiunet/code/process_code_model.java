...
public class process_code_model {
    private String code_title;
    private String code_id;
    private String code_text;
    private String code_imageurl;
    public process_code_model(String codeTitle, String codetext, String codeid, String codeimageurl) {
    ...
    public void setCode_text(String codetext){
