...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHoloder> {

    Context context;
    ArrayList<process_code_model> process_code_list;
    public RecyclerViewAdapter(Context context, ArrayList<process_code_model> process_code_list){
    ...
    public MyViewHoloder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(this.context).inflate(R.layout.list_process_code,parent,false);
    ...
    public static class MyViewHoloder extends RecyclerView.ViewHolder{
        ...
        public MyViewHoloder(@NonNull View itemView) {
            super(itemView);
            codetitle=itemView.findViewById(R.id.user_name);
